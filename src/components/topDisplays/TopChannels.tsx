  ...
  const rows = topChannels.map((c, i) => (
    ...
    >
      ...
      <td className="px-4 py-3 overflow-hidden min-w-0">
        <MarqueeText text={c.name} rotation="hover" className="text-base" />
      </td>
      <td className="px-4 py-3 overflow-hidden min-w-0">
        <MarqueeText text={c.serverName} rotation="hover" className="text-sm text-slate-600 dark:text-slate-400" />
      </td>
